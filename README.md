...
برد کنترلر ماژولار ORCA 3D SPRINGER همانطور که از اسمش مشخص است تشکیل شده از چند ماژول مختلف است که توسط کابل های فلت به یکدیگر متصل میشوند.
